...
from Yolov5s.msg import BoundingBox, BoundingBoxes
...
class DetectorManager():
    def __init__(self):
        ...
        self.image0_topic = rospy.get_param('~image0_topic', '/iris_0/stereo_camera/left/image_raw')
        # self.image1_topic = rospy.get_param('~image1_topic', '"iris_0/stereo_camera/right/image_raw')
        ...
        # Define subscribers
        self.image_sub = rospy.Subscriber(self.image0_topic, Image, self.image_callback, queue_size=1, buff_size=2 ** 24)
